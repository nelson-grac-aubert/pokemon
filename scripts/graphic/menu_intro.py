...
# Duration of the intro animation (12 seconds) to match the music
INTRO_DURATION = 12000  

def run_intro(screen, clock, pokedex):
    width, height = screen.get_size()

    # Pokémon indexes to display
    STARTERS = [0, 3, 6]          # Starters : Bulbasaur, Charmander, Squirtle
    LEGENDARIES = [143, 144, 145] # Legendary birds : Articuno, Zapdos, Moltres
    ...
    while running:
        ...
        skip_text = skip_font.render("Click to skip", True, (255, 255, 255))
