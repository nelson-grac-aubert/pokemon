...
venusaur    = make_pokemon("003", "Venusaur",       [grass, poison], "final")

charmander  = make_pokemon("004", "Charmander",     [fire],          "base_mid")
charmeleon  = make_pokemon("005", "Charmeleon",     [fire],          "intermediate")
charizard   = make_pokemon("006", "Charizard",      [fire, flying],  "final")

squirtle    = make_pokemon("007", "Squirtle",       [water],         "base_mid")
wartortle   = make_pokemon("008", "Wartortle",      [water],         "intermediate")
blastoise   = make_pokemon("009", "Blastoise",      [water],         "final")

caterpie    = make_pokemon("010", "Caterpie",       [bug],           "base_weak")
metapod     = make_pokemon("011", "Metapod",        [bug],           "base_weak")
butterfree  = make_pokemon("012", "Butterfree",     [bug, flying],   "fast")

weedle      = make_pokemon("013", "Weedle",         [bug, poison],   "base_weak")
kakuna      = make_pokemon("014", "Kakuna",         [bug, poison],   "base_weak")
beedrill    = make_pokemon("015", "Beedrill",       [bug, poison],   "fast")
...
zubat       = make_pokemon("041", "Zubat",          [poison, flying],"base_weak")
...
magikarp    = make_pokemon("129", "Magikarp",       [water],         "base_weak")
