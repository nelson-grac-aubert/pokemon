...
bulbasaur   = make_pokemon("001", "Bulbasaur",      [grass, poison], (12, 6, 6, 6, "base_mid"))
ivysaur     = make_pokemon("002", "Ivysaur",        [grass, poison], (12, 6, 6, 6, "intermediate"))
venusaur    = make_pokemon("003", "Venusaur",       [grass, poison], (12, 6, 6, 6, "final"))

charmander  = make_pokemon("004", "Charmander",     [fire],          (12, 6, 6, 6, "base_mid"))
charmeleon  = make_pokemon("005", "Charmeleon",     [fire],          (12, 6, 6, 6, "intermediate"))
charizard   = make_pokemon("006", "Charizard",      [fire, flying],  (12, 6, 6, 6, "final"))

squirtle    = make_pokemon("007", "Squirtle",       [water],         (12, 6, 6, 6, "base_mid"))
wartortle   = make_pokemon("008", "Wartortle",      [water],         (12, 6, 6, 6, "intermediate"))
blastoise   = make_pokemon("009", "Blastoise",      [water],         (12, 6, 6, 6, "final"))

caterpie    = make_pokemon("010", "Caterpie",       [bug],           (12, 5, 6, 6, "base_weak"))
metapod     = make_pokemon("011", "Metapod",        [bug],           (12, 5, 6, 5, "base_weak"))
butterfree  = make_pokemon("012", "Butterfree",     [bug, flying],   (12, 6, 7, 6, "fast"))

weedle      = make_pokemon("013", "Weedle",         [bug, poison],   (12, 6, 5, 6, "base_weak"))
kakuna      = make_pokemon("014", "Kakuna",         [bug, poison],   (12, 5, 6, 6, "base_weak"))
beedrill    = make_pokemon("015", "Beedrill",       [bug, poison],   (12, 7, 6, 6, "fast"))

pidgey      = make_pokemon("016", "Pidgey",         [normal, flying],("base_weak"))
pidgeotto   = make_pokemon("017", "Pidgeotto",      [normal, flying],("intermediate"))
pidgeot     = make_pokemon("018", "Pidgeot",        [normal, flying],("fast"))

rattata     = make_pokemon("019", "Rattata",        [normal],        ("base_weak"))
raticate    = make_pokemon("020", "Raticate",       [normal],        ("base_mid"))

spearow     = make_pokemon("021", "Spearow",        [normal, flying],("base_weak"))
fearow      = make_pokemon("022", "Fearow",         [normal, flying],("fast"))

ekans       = make_pokemon("023", "Ekans",          [poison],        ("base_mid"))
...
sandshrew   = make_pokemon("027", "Sandshrew",      [ground],        ("base_mid"))
sandslash   = make_pokemon("028", "Sandslash",      [ground],        ("base_mid"))
